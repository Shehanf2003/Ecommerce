    ...
    try {
        ...
        if(product.image){
            ...
            try {
                ...
                console.log("deleted image from clouduinary, error")
            }catch (error){
                console.log("Error deleting image from clouduinary", error.message);    
            }
        }
        ...
        res.json({ message: "Product deleted successfully" });   
             ...
             console.log("Error in deleteProduct controller", error.massage);
             res.status(500).json({message: "Server error", error: error.message});   
            }
};
